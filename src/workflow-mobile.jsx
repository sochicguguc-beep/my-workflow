...
export default function App() {
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#1A1A1A", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"flex-start", fontFamily:"'Hiragino Kaku Gothic ProN','Noto Sans JP',sans-serif" }}>
      <style>{`
      ...
      <div className="safe-wrap" style={{ width:"100%", maxWidth:390, minHeight:"100vh", background:T.bg, display:"flex", flexDirection:"column", position:"relative" }}>
